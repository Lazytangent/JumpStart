...
const HomePage = ({ setAuthenticated, setShowModal }) => {
  const [backgroundImg, setBackgroundImg] = useState(
    "https://jumpstartjesse.s3.us-east-2.amazonaws.com/pexels-anna-tarazevich-5697255+(3).jpg"
  );
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setBackgroundImg(
        "https://jumpstartjesse.s3.us-east-2.amazonaws.com/pexels-anna-tarazevich-5697256+(2).jpg"
      );
    }, 3000);
    ...
    setTimeout(() => {
      setBackgroundImg(
        "https://jumpstartjesse.s3.us-east-2.amazonaws.com/pexels-anna-tarazevich-5697262+(2).jpg"
      );
    }, 5500);
  }, [dispatch]);
      ...
      <div className="homePage">
        ...
        <div className="homePage-description-box">
          ...
          <p className="homePage-description-box-body">
            Fundraising for the people and causes you care about. Joining is
